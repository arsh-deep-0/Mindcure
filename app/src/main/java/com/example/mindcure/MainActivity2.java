...
import com.example.mindcure.databinding.ActivityMain2Binding;
import com.example.mindcure.models.users;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnLogin.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View view) {
                                                    startActivity(new Intent(MainActivity2.this,MainSigninActivity.class));
