...
import com.example.mindcure.databinding.ActivityMainMusidBinding;
import com.example.mindcure.databinding.ActivityMainMusikBinding;

public class MainMusidActivity extends AppCompatActivity {
    MediaPlayer player;
    ActivityMainMusidBinding binding;
  /*  ViewGroup tcontainer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*/  tcontainer=findViewById(R.id.tcontainer);
        ...
        binding = ActivityMainMusidBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        binding.btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainMusidActivity.this,MainActivity4.class));
            }
        });
    ...
    public void play(View v){
        if (player==null){
            player=MediaPlayer.create(this,R.raw.dra);
    ...
    private void stopPlayerz(){
        if(player !=null){
            player.release();
            player=null;
            startActivity(new Intent(MainMusidActivity.this,MainMusibActivity.class));
        }
    }
    ...
    private void stopPlayers(){
        if(player !=null){
            player.release();
            player=null;
            startActivity(new Intent(MainMusidActivity.this,MainMusicActivitiy.class));
        }
    }
