...
public class MainMusikActivity extends AppCompatActivity {
    MediaPlayer player;
    ActivityMainMusikBinding binding;
  /*  ViewGroup tcontainer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*/  tcontainer=findViewById(R.id.tcontainer);
        ...
        binding = ActivityMainMusikBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        binding.btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainMusikActivity.this,MainActivity4.class));
            }
        });
    ...
    public void play(View v){
        if (player==null){
            player=MediaPlayer.create(this,R.raw.heal);
    ...
    private void stopPlayerz(){
        if(player !=null){
            player.release();
            player=null;
            startActivity(new Intent(MainMusikActivity.this,MainMusicActivitiy.class));
        }
    }
    ...
    private void stopPlayers(){
        if(player !=null){
            player.release();
            player=null;
            startActivity(new Intent(MainMusikActivity.this,MainMusiaActivity.class));
        }
    }
